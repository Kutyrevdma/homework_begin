...
#
# Используйте форматированный вывод (при помощи % или .format) при вызове print в домашней работе. В качестве
# подсказок можно использовать документацию:
#
# https://pyformat.info/
#
...
# Задание №0
#
# Во время обучения вам будут доступны дополнительные файлы для домашних работ. Всех их вы можете скачать с этого
# репозитория. Далее мы будем к ним обращаться по названиям папок.
#
...
# TODO 2: 1) Сделайте описание квартиры в виде словаря, а не списка. Используйте следующие поля из файла output.csv:
